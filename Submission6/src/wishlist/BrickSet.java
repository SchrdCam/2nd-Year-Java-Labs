...
public class BrickSet implements Comparable<BrickSet>{
	...
	@Override
	/** This method overrides the compareTo method for use by the Collections interface
	 *  so as to dictate how the comparison is done.
	 */
	public int compareTo(BrickSet wishList) {
		//choosing the attribute which is compared when sorting
		if (this.setNumber == wishList.setNumber) {
			return 0;
		} else if( this.setNumber < wishList.setNumber) {
			return -1;
		} else {
			return 1;
		}
